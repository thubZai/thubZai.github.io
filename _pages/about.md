...
🔭 I have deep curiosity and research interests in exploring **Multimodal Learning**, particularly **Vision-Language Models (VLMs), Large Multimodal Models (MLLMs)** & **Diffusion** with insights from **Computer Vision (CV)** & **Deep Reinforcement Learning (RL)**.
